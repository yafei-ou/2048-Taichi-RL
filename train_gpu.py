...
config = {
    ...
    "eval_freq": 2_000,  # Frequency of evaluations during training
...
# Create the environment
env = VecTaichiGame2048Env(num_envs=4, grid_size=4, time_limit=200)  # Wrapping the custom environment in DummyVecEnv
